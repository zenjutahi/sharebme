...
$(function () {  
    ...
    $(".share a")
            ...
            .click(function() {
                ...
                $("#invitation_form").attr("title", "Share folder " + $(a).attr("folder_name") + " with others" ); 
                  
                //a hack to display the different folder names correctly 
                $("#ui-dialog-title-invitation_form").text("Share folder " + $(a).attr("folder_name") + " with others");  
